...
class PostCreateTableResponseTable {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? ToObject(data) : {};
		this.Pos = new PostCreateTableResponseTablePos(d.Pos);
	}
...
class PostCreateTableResponse {
	...
	constructor(data?: any) {
		...
		this.Payload = new PostCreateTableResponseTable(d.Payload);
	}
...
// exports
export {
	PostCreateTableResponseTablePos,
	PostCreateTableResponseTable,
