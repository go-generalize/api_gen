...
import (
	...
	ctrl_controller_0da40676 "github.com/go-generalize/api_gen/v2/pkg/server/tmp/alias_repro/server/mock/controller"
...
func addRoutes(e *echo.Echo, p *props.ControllerProps, opt *options) {
	...
	{
		ctrl := ctrl_controller_0da40676.NewGetController(p)
