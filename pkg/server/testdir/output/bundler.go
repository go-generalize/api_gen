...
import (
	...
	ctrl_controller_6ab8b96d "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller"
	ctrl_service_badd2b1f "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service"
	ctrl_groups_37ba734e "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/groups"
	ctrl_static_page_5ab6f444 "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/static_page"
	ctrl_user_018e342c "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/user"
	ctrl_user2_689c3260 "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/user2"
	ctrl__userID_ad923ceb "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/user2/_userID"
	ctrl__JobID_22e9529d "github.com/go-generalize/api_gen/v2/pkg/server/tmp/output/controller/service/user2/_userID/_JobID"
...
func addRoutes(e *echo.Echo, p *props.ControllerProps, opt *options) {
	...
	{
		ctrl := ctrl_controller_6ab8b96d.NewGetController(p)
	...
	{
		ctrl := ctrl_controller_6ab8b96d.NewPostCreateTableController(p)
	...
	{
		ctrl := ctrl_controller_6ab8b96d.NewPostCreateUserController(p)
	...
	{
		ctrl := ctrl_service_badd2b1f.NewGetArticleController(p)
	...
	{
		ctrl := ctrl_groups_37ba734e.NewGetGroupsController(p)
	...
	{
		ctrl := ctrl_static_page_5ab6f444.NewGetStaticPageController(p)
	...
	{
		ctrl := ctrl_user_018e342c.NewGetController(p)
	...
	{
		ctrl := ctrl_user_018e342c.NewPostUpdateUserNameController(p)
	...
	{
		ctrl := ctrl_user_018e342c.NewPostUpdateUserPasswordController(p)
	...
	{
		ctrl := ctrl_user2_689c3260.NewDeleteUserController(p)
	...
	{
		ctrl := ctrl_user2_689c3260.NewGetUserController(p)
	...
	{
		ctrl := ctrl_user2_689c3260.NewPostUpdateUserNameController(p)
	...
	{
		ctrl := ctrl_user2_689c3260.NewPostUpdateUserPasswordController(p)
	...
	{
		ctrl := ctrl__userID_ad923ceb.NewGetUserJobGetController(p)
	...
	{
		ctrl := ctrl__JobID_22e9529d.NewPutJobController(p)
