...
func NewMockRoutes(router *echo.Group, jsonDir string, w io.Writer) *MockRoutes {
	...
	{
		jd := filepath.Join(jsonDir, "get_article")
		router.GET("article", r.GetArticle(jd))
	}
	return r
}

// GetArticle ...
func (r *MockRoutes) GetArticle(jsonDir string) echo.HandlerFunc {
	type Mock struct {
		Meta struct {
			Status       int                `json:"status"`
			MatchRequest *GetArticleRequest `json:"match_request"`
		} `json:"meta"`
