...
} from './classes/service/user2/_userID/GetUserJobGetRequest';
export {
    GetUserJobGetResponse as ServiceUser2UserIDGetUserJobGetResponse
} from './classes/service/user2/_userID/GetUserJobGetResponse';
