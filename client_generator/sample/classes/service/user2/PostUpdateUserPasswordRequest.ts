...
// classes
// struct2ts:github.com/ORG_NAME/REPO_NAME/server/tools/api_generator/sample/service/user2.PostUpdateUserPasswordRequest
class PostUpdateUserPasswordRequest {
	...
	constructor(data?: any) {
		...
		this.PasswordConfirm = ('PasswordConfirm' in d) ? d.PasswordConfirm as string : '';
	}
