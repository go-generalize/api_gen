...
import (
	...
	ctrl_controller_7b03b320 "github.com/go-gneralize/api_gen/v2/e2e/multipart/controller/controller"
	ctrl__param_cd036786 "github.com/go-gneralize/api_gen/v2/e2e/multipart/controller/controller/_param"
...
func addRoutes(e *echo.Echo, p *props.ControllerProps, opt *options) {
	...
	{
		ctrl := ctrl_controller_7b03b320.NewPostAController(p)
	...
	{
		ctrl := ctrl__param_cd036786.NewPostBController(p)
